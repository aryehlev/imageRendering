...
public class PinholeCamera {
	...
	public Point transform(int x, int y) {
		...
		double R = this.planeWidth / this.resX;

		return Ops.add(this.centerPoint, Ops.add(Ops.mult((x - (int)(this.resX / 2))*R, this.rightVec), Ops.mult(-1*(y - (int)(this.resY / 2))*R, this.upVec)));
